...
class signup:
    def __init__(self,root):
        ...
        def store():
            ...
            if row_e:
                messagebox.showinfo("Hey buddy!", "Email in use. Try Again")
            elif row_p:
                messagebox.showinfo("Hey buddy!", "Phone number in use. Try Again")
            elif row_u:
                messagebox.showinfo("Hey buddy!", "Username in use. Try Again")
            else:
                print("done")
                c.execute(
                    ...
                    {'first_name': v_first_name.get(),
                     ...
                     'security_a': v_security_ans.get()})
                messagebox.showinfo("Welcome to the club!", "Registration Successful!")
        ...
        l_password_note = Label(frame_signup, text="Password should have minimum\n8 characters, 1 alphabet, 1 number", font =("Arial", 7, "bold"),fg="black",bg="white").place(x=45,y=447)
...
# #function
        ...
        e_con_password = Entry(frame_signup, width=24, show="*", textvariable=v_con_password, bg="light grey")
        ...
        b_securityq["values"]=("select","best friend","first pet","favourite school teacher","favourite singer","favourite book","favourite sports-person","favourite movie", "favourite tv show")
        ...
        e_security_a.bind('<Left>', jump_next)
